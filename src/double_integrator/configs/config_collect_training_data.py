...
PROCESS_NOISES = np.logspace(-2, -1, 5, dtype='float32').tolist()
OBSERVATION_NOISES = np.logspace(-1, 0, 5, dtype='float32').tolist()

base_path = '/home/bodrue/Data/neural_control/double_integrator/lqg'
cfg.paths.PATH_FIGURES = os.path.join(base_path, 'figures')
FILEPATH_OUTPUT_DATA = os.path.join(base_path, 'lqg_grid.pkl')
